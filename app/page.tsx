  ...
  return <main className="shell">
    ...
    <section className="hero modeHero">
      ...
      <div className="modeGrid">
        <a href="/free"><span>FREE CONTROL</span><strong>通用远程协作</strong><p>无倒计时、无阵营轮换。房主授权后，远端操作者可以持续控制共享页面。</p><b>进入通用模式 →</b></a>
        <a href="/turns"><span>TURN BASED</span><strong>红蓝回合对战</strong><p>红方远程校准，蓝方固定先手；双方每回合 60 秒，结束或归零后自动交棒。</p><b>进入回合模式 →</b></a>
      </div>
    </section>
  </main>;
}
